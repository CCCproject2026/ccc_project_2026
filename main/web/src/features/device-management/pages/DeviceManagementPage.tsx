import { BatteryWarning, Cpu, Link, WifiOff } from "lucide-react";
...
const mockDevices: DeviceRow[] = [
	...
	},
	{
		...
		elderName: "伊藤 茂",
		roomNumber: "203号室",
		lastCommunication: "06/10 09:12",
	},
	{
		id: "4",
		deviceName: "ESP32-205",
		serialCode: "dev-004",
		battery: 92,
		status: "online",
		elderName: "渡辺 富士子",
		roomNumber: "205号室",
		lastCommunication: "06/10 09:15",
	},
	{
		id: "5",
		deviceName: "ESP32-302",
		serialCode: "dev-005",
		battery: 44,
		status: "online",
		elderName: "加藤 ハル",
		roomNumber: "302号室",
		lastCommunication: "06/10 09:08",
	},
];
...
export function DeviceManagementPage() {
	...
	return (
		<div className="flex flex-col gap-6 pb-6 max-w-[1600px] mx-auto w-full">
			<div className="flex justify-between items-center">
				<div>
					...
					<p className="text-gray-500 text-sm">
						IoTデバイス（ESP32）のバッテリー状態と入所者への割当を管理します
					</p>
				</div>
				<DeviceRegisterModal />
			</div>
			...
			{lowBatteryDevices > 0 && <LowBatteryWarning count={lowBatteryDevices} />}
