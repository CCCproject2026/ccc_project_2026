				...
				<tbody>
					{devices.map((device) => (
						...
						>
							...
							<td className="px-6 py-4">
								<span
									className={`px-2.5 py-1 text-xs rounded-full font-medium flex items-center w-fit gap-1.5 ${
							...
							<td className="px-6 py-4 text-right">
								<div className="flex items-center justify-end gap-2">
									<button
										type="button"
										className="px-3 py-1.5 border border-gray-200 text-gray-600 rounded-lg text-xs font-medium hover:bg-gray-50 flex items-center gap-1.5"
									>
									...
									<button
										...
										className="p-1.5 border border-gray-200 text-gray-400 rounded-lg hover:text-red-600 hover:bg-red-50"
									>
